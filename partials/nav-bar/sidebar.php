...
<nav>
    <div class="sidebar flex-shrink-0 py-3">
...
<!--            <svg class="bi me-2" width="30" height="24"><use xlink:href="#bootstrap"/></svg>-->
            <span class="fs-3 lh-sm fw-bolder">Wonderful<br>平台管理系統</span>
        </a>
        <ul class="list-unstyled ps-0">


            <li class="nav mt-1">
                <button class="nav_btn btn-toggle justify-content-evenly align-items-center collapsed fs-4" data-bs-toggle="collapse" data-bs-target="#firm-collapse1" aria-expanded="false">
                    廠商資料
                </button>
            ...
            <li class="nav mt-1">
                <button class="nav_btn btn-toggle justify-content-evenly align-items-center collapsed fs-4" data-bs-toggle="collapse" data-bs-target="#firm-collapse2" aria-expanded="false">
                    顧客資料
                </button>
            ...
            <li class="nav mt-1">
                <button class="nav_btn btn-toggle justify-content-evenly align-items-center collapsed fs-4" data-bs-toggle="collapse" data-bs-target="#firm-collapse3" aria-expanded="false">
                    課程資訊
                </button>
            ...
            <li class="nav mt-1">
                <button class="nav_btn btn-toggle justify-content-evenly align-items-center collapsed fs-4" data-bs-toggle="collapse" data-bs-target="#firm-collapse4" aria-expanded="false">
                    訂單資訊
                </button>
            ...
            <li class="nav mt-1">
                <button class="nav_btn btn-toggle justify-content-evenly align-items-center collapsed fs-4" data-bs-toggle="collapse" data-bs-target="#firm-collapse5" aria-expanded="false">
                    課程討論
                </button>
...
<script>
    $("#nav_dropdown li").click(function (){
        ...
        $(this).parent().parent().parent().find("button").attr("aria-expanded",true);
        $(this).parent().parent().parent().find("button").removeClass("collapsed");
